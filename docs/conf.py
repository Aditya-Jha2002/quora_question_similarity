# -*- coding: utf-8 -*-
#
# quesimiliarity documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'quesimiliaritydoc'
...
latex_documents = [
    ('index',
     'quesimiliarity.tex',
     u'quesimiliarity Documentation',
     u"Aditya Jha", 'manual'),
]
